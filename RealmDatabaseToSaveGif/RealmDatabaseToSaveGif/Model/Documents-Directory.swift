...
//
//  Created by Md. Faysal Ahmed on 9/1/23.
//
...
class DocumentsDirectory {
    ...
    var newFolderURL = url.appendingPathComponent("Gif-AE")
    ...
    // if we need to access specific folder file then we have to give folderName
    func fetchingGifPhoto(_ folderName: String?=nil, success: @escaping(_ arr: [URL]) -> Void) {
        let folderUrl = newFolderURL
        var gifImageArr: [URL] = []
        do {
